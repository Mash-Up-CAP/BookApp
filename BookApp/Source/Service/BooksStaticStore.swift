...
protocol BooksStaticStoreProtocol {
    func fetchStaticBooks() async throws -> SearchBookResponse
}
//
//final class BooksStaticStore: BooksStaticStoreProtocol {
//    static let books: SearchBookResponse = SearchBookResponse(items: [
//        Item(volumeInfo: Book(title: "book1", authors: ["author1", "author1"], publisher: "가나다라", publishedDate: "2022-12-33",
...
//        Item(volumeInfo: Book(title: "book22", authors: ["author22"], publisher: "바다라가", publishedDate: "2020-33-22",
